...
pw = "it9aUM7o8ohnY5FBtgEd"
db = "boqu686i3arvqfcd306c"

connection = con("boqu686i3arvqfcd306c-mysql.services.clever-cloud.com","uj21uhyj8bu3xhp5",pw)
...
#Getting Data
q1 = 'select * from result12 where Roll =' +roll+';'
connection = condb("boqu686i3arvqfcd306c-mysql.services.clever-cloud.com","uj21uhyj8bu3xhp5",pw,db)
